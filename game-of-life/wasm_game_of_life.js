...
export class Universe {
    ...
    * @returns {Universe}
    */
    static new_fancy(width, height) {
        const ret = wasm.universe_new_fancy(width, height);
        return Universe.__wrap(ret);
    }
    /**
    * @param {number} row
    ...
    */
    unset_cell(row, col) {
        wasm.universe_unset_cell(this.ptr, row, col);
    }
    /**
    * @param {number} row
    * @param {number} col
    */
    set_cell(row, col) {
        wasm.universe_set_cell(this.ptr, row, col);
    }
    /**
    * @param {number} row
    * @param {number} col
    ...
    */
    num_live_cells() {
        const ret = wasm.universe_num_live_cells(this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    num_active_cells() {
        const ret = wasm.universe_num_active_cells(this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    cells_to_paint() {
        const ret = wasm.universe_cells_to_paint(this.ptr);
        return ret;
    }
    /**
    * Clear all cells
